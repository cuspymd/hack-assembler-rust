...
mod tests {
    ...
    fn test_c_instruction_given_jump() {
        let mut parser = Parser::new("0;JMP");
        parser.advance();
    ...
    fn test_c_instruction_given_all() {
        let mut parser = Parser::new("ADM=D+1;JGT");
        parser.advance();
